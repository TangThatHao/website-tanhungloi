...
const memberForgotPasswordLimiter = createRateLimiter({
  max: 3,
  onLimited: (req, res) =>
...
const memberForgotPasswordRateLimit = memberForgotPasswordLimiter.middleware;
